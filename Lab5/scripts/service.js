...
function validateCard(cardID){
    ...
    var c = document.getElementById(cardID).value;
...
function showAlert(){
    if(validatePhone("phone")==true && validateCard("debit")==true){
        alert("Successfully booked, thank you very much!");
    }
    else{
...
$(document).ready(function(){
    ...
    $("#debit").on("change", function(){
        if(!validateCard("debit")){
            alert("Wrong format for card information, Visa only");
            $("#debit").val("Starting with 4, length 13 or 16 digits");
